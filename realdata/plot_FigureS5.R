...
ggsave(filename="FigureS5A.png",plot=p1,device="png",dpi=600,units="in",width=7.8,height=5)
...
p2 <- ggplot(df2,aes(x=Group,y=Simpson))+
  ...
  theme(legend.position = 'none',
        ...
        axis.text = element_text(size = 24),   
        plot.title = element_text(size = 28))
ggsave(filename="FigureS5B.png",plot=p2,device="png",dpi=600,units="in",width=7.8,height=5)
...
ggsave(filename="FigureS5C.png",plot=p3,device="png",dpi=600,units="in",width=10,height=5)
